var menuData = {
    ...
    "payloads": [
      {
        ...
        "PL-Bin": "INFO",
        "PL-Ver": "Menu Info:",
        "PL-Desc": "Contains payloads to exploit and run homebrew on <br>your PS4.<br>Other payloads that are frequently used can also be found<br>here like FTP and Bin Loader.",
        "Icon": "&#xf30f;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
  ...
  "Dumper": {
    ...
    "payloads": [
      ...
      {
        "PL-Title": "Dump Game SGK84",
        "PL-Bin": "pl_gamedumperCISS.bin",
        "PL-Ver": "Mod By SGK84",
        "PL-Desc": "Dump your games or apps to a USB drive to be able to create fpkg files.<br>",
        "Icon": "&#xf1b3;",
        "FW": ["12.xx","11.xx","10.xx","9.xx","8.xx","7.xx"]
      }
    ]
  },
  "Spoof": {
  ...
  "Game Mods": {
    ...
    "payloads": [
      ...
      {
        "PL-Title": "ArabicGuy Menu For GTA V v1.00",
        "PL-Bin": "pl_GTA_ArabicGuy100.bin",
        "PL-Ver": "v1.0 - By RF0oDxM0Dz/Port By Karo",
        "PL-Desc": "Mod Menu for GTA V<br>*Game update v1.00 must be installed.<br><br>Activate Menu With: 'L1 + R1'",
        "Icon": "&#xf5e1;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
      ...
      },
      {
        ...
        "PL-Ver": "v1.33 - By GraFfiX_221211",
        "PL-Desc": "Mod Menu for GTA V<br>*Game update v1.33 must be installed.<br><br>Activate Menu With: 'D-Pad Right + Square'",
        "Icon": "&#xf63b;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        ...
        "PL-Ver": "v1.34 - By GraFfiX_221211",
      ...
      },
      {
        ...
        "PL-Ver": "v1.38 - By GraFfiX_221211",
      ...
      {
        "PL-Title": "NorthMod Menu For RDR2 V1.29",
        "PL-Ver": "v1.29 - By david1337hax",
        "PL-Bin": "pl_RDR2_North129.bin",
        "PL-Desc": "Mod Menu fMod Menu for RDR2 <br>*Game update v1.29 must be installed.<br><br>Activate Menu With: 'R1 + Square'",
        "Icon": "&#xF6F0;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
    ...
    "payloads": [
      {
        ...
        "PL-Bin": "INFO",
        "PL-Ver": "Menu Info:",
        "PL-Desc": "Fan Speed PS4.",
        "Icon": "&#xf30f;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed Default",
        "PL-Bin": "pl_fan-speed-default.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed Default.",
        "Icon": "&#xf2c9;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 65",
        "PL-Bin": "pl_fan-speed-65.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 65.",
        "Icon": "&#xf2c9;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 70",
        "PL-Bin": "pl_fan-speed-70.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 70.",
        "Icon": "&#xf2c8;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 72",
        "PL-Bin": "pl_fan-speed-72.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 72.",
        "Icon": "&#xf2c8;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 74",
        "PL-Bin": "pl_fan-speed-74.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 74.",
        "Icon": "&#xf2c8;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 75",
        "PL-Bin": "pl_fan-speed-75.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 75.",
        "Icon": "&#xf2c8;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 76",
        "PL-Bin": "pl_fan-speed-76.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 76.",
        "Icon": "&#xf2c8;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 78",
        "PL-Bin": "pl_fan-speed-78.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 78.",
        "Icon": "&#xf2c8;",
        "FW": ["9.xx","8.xx","7.xx"]
      },
      {
        "PL-Title": "Fan Speed 80",
        "PL-Bin": "pl_fan-speed-80.bin",
        "PL-Ver": "v1.00 - By PS4",
        "PL-Desc": "Fan Speed 80.",
        "Icon": "&#xf2c7;",
        "FW": ["9.xx","8.xx","7.xx"]
      }
    ]
